...
contextBridge.exposeInMainWorld('RefBoardAPI', {
  ...
  getAnimaticsPreviewCacheSettings: () => ipcRenderer.invoke('get-animatics-preview-cache-settings'),
  setAnimaticsPreviewCacheSettings: (settings) => ipcRenderer.invoke('set-animatics-preview-cache-settings', settings),
  chooseAnimaticsPreviewCacheFolder: () => ipcRenderer.invoke('choose-animatics-preview-cache-folder'),
  clearAnimaticsPreviewCache: () => ipcRenderer.invoke('clear-animatics-preview-cache'),
  getAnimaticsPreviewCache: (fingerprint) => ipcRenderer.invoke('get-animatics-preview-cache', fingerprint),
  getAnimaticsPreviewCacheStats: () => ipcRenderer.invoke('get-animatics-preview-cache-stats'),
  beginAnimaticsPreviewCache: (settings) => ipcRenderer.invoke('begin-animatics-preview-cache', settings),
