...
const smokeExpression = String.raw`(async()=>{
  ...
  return {
    ...
    liveClipDuration,durationSpacePlayed,durationFocusRetained,durationHistoryBefore,durationHistoryAfter,liveTextSize,textSizeSpacePlayed,textSizeFocusRetained,textareaSpaceDidNotPlay,inlineEditorOpen,inlineCanvasPaints,inlineTextValue,inlineEditorWidth,inlineBorderStyle,inlineRatioBefore,inlineRatioLow,portraitCenterX,portraitCenterY,activeText,
