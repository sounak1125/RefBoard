...
const smokeExpression = String.raw`(async()=>{
  ...
  return {
    ...
    liveClipDuration,durationSpacePlayed,durationFocusRetained,durationHistoryBefore,durationHistoryAfter,liveTextSize,textSizeSpacePlayed,textSizeFocusRetained,textareaSpaceDidNotPlay,textColorPopOpen,customTextColor,textColorSwatch,noNativeTextColor,inlineEditorOpen,inlineCanvasPaints,inlineTextValue,inlineEditorWidth,inlineBorderStyle,inlineRatioBefore,inlineRatioLow,portraitCenterX,portraitCenterY,activeText,
