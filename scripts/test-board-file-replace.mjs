...
assert.match(main, /await replaceBoardFile\(session\.target, tempPath\);/, 'a new or converted board is swapped in with a stable .bak instead of deleting a UUID backup');
